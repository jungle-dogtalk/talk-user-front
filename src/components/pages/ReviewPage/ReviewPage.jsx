    ...
    <div className="review-page">
      ...
      <div className="review-container">
        ...
        <div className="reviews">
          {[{name: '시그로자보중', img: profile1}, {name: '엄멍', img: profile2}, {name: '우하하', img: profile3}].map((user, index) => (
            <div key={index} className="review-item">
              <img src={user.img} alt={user.name} className="review-picture" />
              <div className="review-details">
                ...
                <button className="report-button" onClick={() => handleReport(user.name)}>
                  신고하기
                </button>
              </div>
            </div>
        ...
        <button className="submit-button" onClick={handleSubmitReview}>완료</button>
      </div>
    </div>
  );
};
